                                       ...
                                       <div class="overlay he-view">
                                            <div class="bg a0" data-animate="fadeIn">
                                                <div class="center-bar v1">
                                                    ...
                                                    <h4><?php echo get_the_title() ?></h4>
                                                    <span class="cat"><?php echo $sort_classes ?></span>
                                                    <p><?php echo themeple_text_limit(get_the_excerpt(), 14) ?></p>
                 ...
                 <div class="portfolio-item <?php echo $sort_classes ?> <?php echo $portfolio_style ?>" data-id="<?php echo get_the_ID() ?>">
                        ...
                        <?php } ?>
                         ...
                         <?php } ?>
                                     ...
                                     <?php if(isset($themeple_config['dynamic_portfolio']['show_desc_bool']) && $themeple_config['dynamic_portfolio']['show_desc_bool']): ?>
                                        <div class="show_text">
